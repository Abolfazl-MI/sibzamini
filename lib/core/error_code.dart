...
const String DISSABLED_LOCATION_SERVICE='سرویس مکان یاب را روشن کنید' ;
const String LOCATION_ACCESS_DENIDD='برای ادامه استفاده از اپلیکیشن نیاز به دسترسی مکانی داریم ';
